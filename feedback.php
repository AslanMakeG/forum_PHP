...
<body>
    <div class="main-content">
        <div class="bread-crumbs">
            ...
            <p class="crumb">></p>
            <p class="crumb">Обратная связь</p>
        </div>

        <div class="other">
            <div class="other-head">
                <p style="color: white; font-family: Roboto-Light;">Обратная связь</p>
            </div>
            <div class="other-body">
                <a class="rule" href="vk.com">Вконтакте</a>
                <p class="rule" >Наша почта: forum@forum.ru</p>
            </div>
        </div>
    </div>
</body>
